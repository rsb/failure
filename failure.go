...
func ToInvalidState(e error, format string, a ...any) error {
...
// it has not.
func NoChange(format string, a ...any) error {
...
func ToNoChange(e error, format string, a ...any) error {
...
func Warn(format string, a ...any) error {
...
func ToWarn(e error, format string, a ...any) error {
	cause := Warn(e.Error())
	return Wrap(cause, format, a...)
}
...
func ToOutOfRange(e error, format string, a ...any) error {
...
func Panic(format string, a ...any) error {
...
func ToPanic(e error, format string, a ...any) error {
	cause := Panic(e.Error())
	return Wrap(cause, format, a...)
}
...
func MissingFromContext(format string, a ...any) error {
...
func ToMissingFromContext(e error, format string, a ...any) error {
...
func ToStartup(e error, format string, a ...any) error {
...
func ToTimeout(e error, format string, a ...any) error {
...
func ToConfig(e error, format string, a ...any) error {
...
func ToInvalidParam(e error, format string, a ...any) error {
...
func Ignore(format string, a ...any) error {
...
// the error itself.
func ToIgnore(e error, format string, a ...any) error {
...
func ToNotFound(e error, format string, a ...any) error {
...
func NotAuthorized(format string, a ...any) error {
...
func ToNotAuthorized(e error, format string, a ...any) error {
...
func NotAuthenticated(format string, a ...any) error {
...
func ToNotAuthenticated(e error, format string, a ...any) error {
...
func ToForbidden(e error, format string, a ...any) error {
...
func ToDefer(e error, format string, a ...any) error {
	cause := Defer(e.Error())
	return Wrap(cause, format, a...)
}

// Shutdown is used to signal that the app should shut down.
func Shutdown(format string, a ...any) error {
	return Wrap(ShutdownErr, format, a...)
}

func ToShutdown(e error, format string, a ...any) error {
...
func Server(format string, a ...any) error {
...
func ToServer(e error, format string, a ...any) error {
...
func ToSystem(e error, format string, a ...any) error {
